                    ...
                    <div class="panel panel-primary">
						...
						<form name="form" method="post">
                            <div class="form-group">
							 ...
							 <center><input type="submit" name="add" value="Add New" class="btn btn-primary"><br><br><br> 
                             <center><img src="logo.jpg" style="height:300px;border-radius:50%;">
							</form>
							<?php
							 include('db.php');
							 if(isset($_POST['add']))
            ...
            <div class="row">
                <div class="col-md-6 col-sm-6">
                    ...
                    <div class="panel panel-default">
                        <?php
						$sql = "select * from room limit 0,20";
