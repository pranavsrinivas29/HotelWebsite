...
@page { margin: 0; }
	...
	?>
		<header>
			...
			<address >
				<p>THE BELFRY HOTEL,</p>
				<p>	96,Little Italy,<br>Heritage Town, Pondicherry,60500<br></p>
				<p>	(+91) 604-33-565</p>
			</address>
			<span><img alt="Avatar" style="width:150px;border-radius: 50%;" src="assets/img/logo.jpg"></span>
		</header>
		<article>
			<h1></h1>
			<address >
		...
		<aside>
			...
			<div >
				<p align="center">Email :- thebelfry@gmail.com || Web :- www.thebelfry.com || Phone :- (+91) 604-33-565 </p>
			</div>
		</aside>
	</body>
</html>
